...
class Solution(Reader):
    ...
    def preprocessing(self):
        ...
        file.fname = '한국어_단발성_대화_데이터셋'
        header = [1]
        cols = 'A , B'
        skiprows = [2]
        chatbot_data = self.xls('./data/한국어_단발성_대화_데이터셋.xlsx', header, cols, skiprows)'''
...
class BERTDataset(Dataset):
    ...
    def tokenizer(self):
        ...
        data_train = BERTDataset(self.dataset_train, 0, 1, tok, self.max_len, True, False)
        data_test = BERTDataset(self.dataset_test, 0, 1, tok, self.max_len, True, False)
